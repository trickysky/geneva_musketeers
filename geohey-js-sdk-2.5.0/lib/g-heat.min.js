...
b,d){var c=this._map,f=this.options;if(d){var g=f.topValue,e=f.radius/this._bkScale;"baseMap"==f.radiusUnit&&(e/=c._res);this._circleRadius&&this._circleRadius==e||this._updateCircle(e,e);f=this._actx;e=c._canvasOffset;b=c.toScreen([a,b]);a=b[0]+e[0];b=b[1]+e[1];d=Math.min(1,d/g);f.globalAlpha=d;f.drawImage(this._cctx.canvas,a/this._bkScale-this._circleR,b/this._bkScale-this._circleR)}}});
...
d.arc(f-g,f-g,a,0,2*Math.PI,!0);d.closePath();d.fill();this._circleRadius=a;this._circleR=f;return this},_drawA:function(a,b,d){var c=this._map,f=this.options;if(d){var g=f.topValue,e=f.radius/this._bkScale;"baseMap"==f.radiusUnit&&(e/=c._res);this._circleRadius&&this._circleRadius==e||this._updateCircle(e,e);f=this._actx;e=c._canvasOffset;b=c.toScreen([a,b]);a=b[0]+e[0];b=b[1]+e[1];d=Math.min(1,d/g);f.globalAlpha=d;f.drawImage(this._cctx.canvas,a/this._bkScale-this._circleR,b/this._bkScale-this._circleR)}}});
