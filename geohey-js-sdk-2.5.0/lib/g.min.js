...
a.addClass(this._container,"retina");b.ielt9&&a.addClass(this._container,"ielt9");this._mapFrame=a.create("div","g-baseMap-frame",this._container);this._layersFrame=a.create("div","g-layers-frame",this._mapFrame);var c=this._popup=a.create("div","g-popup",this._mapFrame),d=a.create("div","g-popup-wrapper",c);this._popupClose=a.create("div","g-popup-close",d);d=a.create("div","g-popup-content",d);this._popupContentWrapper=a.create("div","g-popup-content-wrapper",d);this._popupPointer=a.create("div","g-popup-pointer",
